		...
		<div id="content-wrapper">
			...
			<div class="card mb-3">
				<div class="card-header">
					<a href="<?php echo site_url('admin/banking/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
				</div>
				<div class="card-body">
					
					<form action="" method="post" enctype="multipart/form-data">

						<input type="hidden" name="id" value="<?php echo $banking->id_banking ?>">
						...
						<div class="form-group">
							...
							<input autocomplete="off" class="form-control <?php echo form_error('jumlah_tf_banking') ? 'is-invailid':'' ?>" type="double" name="jumlah_tf_banking" value="<?php echo $banking->jumlah_tf_banking ?>">
							<div class="invalid-feedback">
						...
						<div class="form-group">
							...
							<input autocomplete="off" class="form-control <?php echo form_error('tgl_tf_banking') ? 'is-invailid':'' ?>" type="date" name="tgl_tf_banking" value="<?php echo $banking->tgl_tf_banking ?>">
							<div class="invalid-feedback">
						...
						<div class="form-group">
							...
							<input class="form-control <?php echo form_error('tgl_konfirmasi_banking') ? 'is-invailid' :'' ?>" type="date" name="tgl_konfirmasi_banking" min="0" value="<?php echo $banking->tgl_konfirmasi_banking ?>" />
							<div class="invalid-feedback">
						...
						<div class="form-group">
							<label for="Status">*Status_Banking</label>
								...
								<option value="<?php echo $banking->status_banking ?>">--Pilih--</option>
									<?php  
										$pilihan = array("Y","N");
