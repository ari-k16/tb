					...
					<div class="card-body">
						...
						<form action="" method="post" enctype="multipart/form-data">
							<!-- Note atribut action dikosongkan, artinya actionnya akan di proses 
								...
								<input type="hidden" name="id" value="<?php echo $product->id_products ?>">
								...
								<div class="form-group">
									...
									<textarea class="form-control <?php echo form_error('description') ? 'is-invailid':'' ?>" name="description" placeholder="Product description"><?php echo $product->description ?></textarea>
									<div class="invalid-feedback">
